...
fun BoxExample(){
    ...
    Box(
        ...
        Text(text="Note 01", fontSize = 30.sp,
            modifier=Modifier.align(Alignment.BottomEnd))

        Text(text="Note 02", fontSize = 30.sp, modifier = Modifier.align(Alignment.TopEnd))

        Text(text="Note 03", fontSize = 30.sp, modifier = Modifier.align(Alignment.CenterStart))
    }
